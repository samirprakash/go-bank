...
import (
	...
	mockdb "github.com/samirprakash/go-bank/db/mock"
...
// requireBodyMatchAccount matches the response account from a GetAccount API request
// with the random account that was created for testing
